...
<g stroke="#59351f" strokeWidth="10" strokeLinejoin="round" strokeLinecap="round">
 <path id={`${uid}-thinking-body`} data-part="body" fill={`url(#${uid}-thinking-fur)`} d="M162 497 C105 530 65 591 67 645 C64 695 92 716 144 711 L566 667 C581 613 551 535 511 455 Z"/>
 ...
 <clipPath id={`${uid}-thinking-left-eye-clip`}><use href={`#${uid}-thinking-left-eye`} /></clipPath><g clipPath={`url(#${uid}-thinking-left-eye-clip)`}><path id={`${uid}-thinking-left-pupil`} data-part="left-pupil" stroke="none" fill="#633d26" d="M220 316 C210 304 213 280 228 276 C245 272 257 289 254 310 C245 321 232 322 220 316 Z"/></g>
 ...
 <clipPath id={`${uid}-thinking-right-eye-clip`}><use href={`#${uid}-thinking-right-eye`} /></clipPath><g clipPath={`url(#${uid}-thinking-right-eye-clip)`}><path id={`${uid}-thinking-right-pupil`} data-part="right-pupil" stroke="none" fill="#633d26" d="M432 287 C423 273 426 249 440 246 C457 244 469 262 465 280 C456 291 442 295 432 287 Z"/></g>
 <g className="eye-highlights" fill="#fffdf5" stroke="none"><ellipse cx="240" cy="283" rx="6" ry="6"/><ellipse cx="451" cy="254" rx="6" ry="6"/></g>
...
<g id={`${uid}-thinking-thinking-paw`} data-part="thinking-paw"><path fill={`url(#${uid}-thinking-fur)`} d="M524 638 C570 624 590 588 567 551 L494 444 C482 424 470 413 454 416 C447 400 431 397 421 409 C407 400 392 409 391 424 C371 421 363 439 374 455 C385 478 414 489 442 485 L480 579 C454 602 477 650 524 638 Z"/><path fill="#805033" stroke="none" d="M545 571 C561 599 541 622 519 627 C498 633 480 621 482 604 C466 629 495 650 524 638 C569 624 589 588 567 551 L503 458 L486 467 Z"/><path fill="none" stroke="#c39570" strokeWidth="7" d="M501 570 L457 482 M382 438 Q386 453 408 460"/><path fill="none" strokeWidth="6" d="M392 426 Q401 442 415 443 M422 412 Q425 432 437 438 M454 420 L463 440"/></g>
</g>
